...
- Name: nav.spec.ts >> shell + navigation >> status footer reflects the live engine connection
- Location: specs\nav.spec.ts:38:3
...
Locator: getByLabel('Engine status')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByLabel('Engine status')
